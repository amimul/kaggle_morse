...
while (!feof(fid))
	...
	SNR = randi([-14,20]);		% SNR between -14 dB ... + 20 dB
	WPM = randi([12,80]);    	% Speed between 12 ... 80 WPM
	Set = randi([1,2]);			% Set 1=training, 2=testing
	Tune = randi([600,1200]);	% Null beat between 600 ... 1200 Hz
